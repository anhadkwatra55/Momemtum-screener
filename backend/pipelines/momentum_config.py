...
QUOTES = [
    ...
    {"text": "He who lives by the crystal ball will eat shattered glass.",
     "author": "Ray Dalio"},
    {"text": "I never place a bet unless the odds are in my favor.",
     "author": "Ed Thorp"},
    {"text": "Risk management is not about predicting the future, it is about preparing for it.",
     "author": "Nassim Taleb"},
    {"text": "I have two basic rules about winning in trading as well as in life: 1. If you don't bet, you can't win. 2. If you lose all your chips, you can't bet.",
     "author": "Larry Hite"},
    {"text": "I know where I'm getting out before I get in.",
     "author": "Bruce Kovner"},
    {"text": "The market is a constantly evolving system. The only way to survive is to be systematically adaptable.",
