...
# ── Static File Mounting (for AI Generated Images) ──
# This allows the frontend to fetch images generated by the NewsletterArtist pipeline.
INTEL_DIR = Path(__file__).parent.parent / "frontend" / "public" / "intel"
if not INTEL_DIR.exists():
    INTEL_DIR.mkdir(parents=True, exist_ok=True)
app.mount("/intel", StaticFiles(directory=str(INTEL_DIR)), name="intel")
